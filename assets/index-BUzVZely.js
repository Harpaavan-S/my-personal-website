...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ga(e,t,n){let r=new Float32Array(na),i=new q(0,1,0);return new Qr({name:`SphericalGaussianBlur`,defines:{n:na,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ya(),fragmentShader:`
	...
	`}var ba=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Rr(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;window.onscroll=function(){lc()};function lc(){var e=100-(document.body.scrollTop||document.documentElement.scrollTop)/(document.documentElement.scrollHeight-document.documentElement.clientHeight)*100;document.querySelector(`.timeline`).style.clipPath=`inset(0 `+e+`% 0 0)`}window.addEventListener(`load`,()=>{let e=document.getElementById(`loader`),t=document.querySelector(`.hero-content`);setTimeout(()=>{e.classList.add(`hidden`),t.classList.add(`visible`)},1500)});var uc=document.querySelectorAll(`.reveal`),dc=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?e.target.classList.add(`visible`):e.target.classList.remove(`visible`)})},{threshold:.15});uc.forEach(e=>{dc.observe(e)}),document.querySelectorAll(`.bloops`).forEach(e=>{let t=e.querySelectorAll(`.skill-icon`),n=t[0].offsetTop;t.forEach(e=>{e.offsetTop>n&&e.classList.add(`below`)})}),document.addEventListener(`DOMContentLoaded`,()=>{let e=document.getElementById(`imageModal`),t=document.getElementById(`modalImg`);document.querySelectorAll(`.trigger`).forEach(n=>{n.addEventListener(`click`,r=>{r.preventDefault();let i=`/my-personal-website/`+n.getAttribute(`href`).replace(/^\//,``);console.log(`Trying to load:`,i),t.setAttribute(`src`,i),e.classList.add(`open`)})}),e.addEventListener(`click`,n=>{n.target!==t&&e.classList.remove(`open`)})});var $={brushSize:25,brushStrength:2,distortionAmount:3,fluidDecay:.95,trailLength:.8,stopDecay:.85,color1:`#4e0070`,color2:`#25004f`,color3:`#000000`,color4:`#06003e`,colorIntensity:1,softness:.3};function fc(e){return[parseInt(e.slice(1,3),16)/255,parseInt(e.slice(3,5),16)/255,parseInt(e.slice(5,7),16)/255]}var pc=new wi(-1,1,1,-1,0,1),mc=new ac({antialias:!0});mc.setPixelRatio(1);var hc=document.querySelector(`.gradient-canvas`);mc.setSize(window.innerWidth,window.innerHeight),hc.appendChild(mc.domElement);var gc=new wt(window.innerWidth,window.innerHeight,{minFilter:o,magFilter:o,format:w,type:h,wrapS:t,wrapT:t,generateMipmaps:!1,depthBuffer:!1,stencilBuffer:!1}),_c=new wt(window.innerWidth,window.innerHeight,{minFilter:o,magFilter:o,format:w,type:h,wrapS:t,wrapT:t,generateMipmaps:!1,depthBuffer:!1,stencilBuffer:!1}),vc=gc,yc=_c,bc=0,xc=new Qr({uniforms:{iTime:{value:0},iResolution:{value:new K(window.innerWidth,window.innerHeight)},iMouse:{value:new St(0,0,0,0)},iFrame:{value:0},iPreviousFrame:{value:null},uBrushSize:{value:$.brushSize},uBrushStrength:{value:$.brushStrength},uFluidDecay:{value:$.fluidDecay},uTrailLength:{value:$.trailLength},uStopDecay:{value:$.stopDecay}},vertexShader:oc,fragmentShader:sc}),Sc=new Qr({uniforms:{iTime:{value:0},iResolution:{value:new K(window.innerWidth,window.innerHeight)},iFluid:{value:null},uDistortionAmount:{value:$.distortionAmount},uColor1:{value:new q(...fc($.color1))},uColor2:{value:new q(...fc($.color2))},uColor3:{value:new q(...fc($.color3))},uColor4:{value:new q(...fc($.color4))},uColorIntensity:{value:$.colorIntensity},uSoftness:{value:$.softness}},vertexShader:oc,fragmentShader:cc}),Cc=new Ur(2,2),wc=new Er(Cc,xc),Tc=new Er(Cc,Sc),Ec=0,Dc=0,Oc=0,kc=0,Ac=0;document.addEventListener(`mousemove`,e=>{let t=hc.getBoundingClientRect();Oc=Ec,kc=Dc,Ec=e.clientX-t.left,Dc=t.height-(e.clientY-t.top),Ac=performance.now(),xc.uniforms.iMouse.value.set(Ec,Dc,Oc,kc)}),document.addEventListener(`mouseleave`,()=>{xc.uniforms.iMouse.value.set(0,0,0,0)});function jc(){requestAnimationFrame(jc);let e=performance.now()*.001;xc.uniforms.iTime.value=e,Sc.uniforms.iTime.value=e,xc.uniforms.iFrame.value=bc,performance.now()-Ac>100&&xc.uniforms.iMouse.value.set(0,0,0,0),xc.uniforms.uBrushSize.value=$.brushSize,xc.uniforms.uBrushStrength.value=$.brushStrength,xc.uniforms.uFluidDecay.value=$.fluidDecay,xc.uniforms.uTrailLength.value=$.trailLength,xc.uniforms.uStopDecay.value=$.stopDecay,Sc.uniforms.uDistortionAmount.value=$.distortionAmount,Sc.uniforms.uColorIntensity.value=$.colorIntensity,Sc.uniforms.uSoftness.value=$.softness,Sc.uniforms.uColor1.value.set(...fc($.color1)),Sc.uniforms.uColor2.value.set(...fc($.color2)),Sc.uniforms.uColor3.value.set(...fc($.color3)),Sc.uniforms.uColor4.value.set(...fc($.color4)),xc.uniforms.iPreviousFrame.value=yc.texture,mc.setRenderTarget(vc),mc.render(wc,pc),Sc.uniforms.iFluid.value=vc.texture,mc.setRenderTarget(null),mc.render(Tc,pc);let t=vc;vc=yc,yc=t,bc++}window.addEventListener(`resize`,()=>{let e=window.innerWidth,t=window.innerHeight;mc.setSize(e,t),xc.uniforms.iResolution.value.set(e,t),Sc.uniforms.iResolution.value.set(e,t),gc.setSize(e,t),_c.setSize(e,t),bc=0}),jc();