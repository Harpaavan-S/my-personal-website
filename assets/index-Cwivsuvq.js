...
`;window.onscroll=function(){lc()};function lc(){var e=100-(document.body.scrollTop||document.documentElement.scrollTop)/(document.documentElement.scrollHeight-document.documentElement.clientHeight)*100;document.querySelector(`.timeline`).style.clipPath=`inset(0 `+e+`% 0 0)`}window.addEventListener(`load`,()=>{let e=document.getElementById(`loader`),t=document.querySelector(`.hero-content`);setTimeout(()=>{e.classList.add(`hidden`),t.classList.add(`visible`)},1500)}),document.querySelectorAll(`.bloops`).forEach(e=>{let t=e.querySelectorAll(`.skill-icon`),n=t[0].offsetTop;t.forEach(e=>{e.offsetTop>n&&e.classList.add(`below`)})});var $={brushSize:25,brushStrength:2,distortionAmount:3,fluidDecay:.98,trailLength:.8,stopDecay:.85,color1:`#4e0070`,color2:`#25004f`,color3:`#000000`,color4:`#06003e`,colorIntensity:1,softness:.3};function uc(e){return[parseInt(e.slice(1,3),16)/255,parseInt(e.slice(3,5),16)/255,parseInt(e.slice(5,7),16)/255]}var dc=new wi(-1,1,1,-1,0,1),fc=new ac({antialias:!0});fc.setPixelRatio(1);var pc=document.querySelector(`.gradient-canvas`);fc.setSize(window.innerWidth,window.innerHeight),pc.appendChild(fc.domElement);var mc=new wt(window.innerWidth,window.innerHeight,{minFilter:o,magFilter:o,format:w,type:h,wrapS:t,wrapT:t,generateMipmaps:!1,depthBuffer:!1,stencilBuffer:!1}),hc=new wt(window.innerWidth,window.innerHeight,{minFilter:o,magFilter:o,format:w,type:h,wrapS:t,wrapT:t,generateMipmaps:!1,depthBuffer:!1,stencilBuffer:!1}),gc=mc,_c=hc,vc=0,yc=new Qr({uniforms:{iTime:{value:0},iResolution:{value:new K(window.innerWidth,window.innerHeight)},iMouse:{value:new St(0,0,0,0)},iFrame:{value:0},iPreviousFrame:{value:null},uBrushSize:{value:$.brushSize},uBrushStrength:{value:$.brushStrength},uFluidDecay:{value:$.fluidDecay},uTrailLength:{value:$.trailLength},uStopDecay:{value:$.stopDecay}},vertexShader:oc,fragmentShader:sc}),bc=new Qr({uniforms:{iTime:{value:0},iResolution:{value:new K(window.innerWidth,window.innerHeight)},iFluid:{value:null},uDistortionAmount:{value:$.distortionAmount},uColor1:{value:new q(...uc($.color1))},uColor2:{value:new q(...uc($.color2))},uColor3:{value:new q(...uc($.color3))},uColor4:{value:new q(...uc($.color4))},uColorIntensity:{value:$.colorIntensity},uSoftness:{value:$.softness}},vertexShader:oc,fragmentShader:cc}),xc=new Ur(2,2),Sc=new Er(xc,yc),Cc=new Er(xc,bc),wc=0,Tc=0,Ec=0,Dc=0,Oc=0;document.addEventListener(`mousemove`,e=>{let t=pc.getBoundingClientRect();Ec=wc,Dc=Tc,wc=e.clientX-t.left,Tc=t.height-(e.clientY-t.top),Oc=performance.now(),yc.uniforms.iMouse.value.set(wc,Tc,Ec,Dc)}),document.addEventListener(`mouseleave`,()=>{yc.uniforms.iMouse.value.set(0,0,0,0)});function kc(){requestAnimationFrame(kc);let e=performance.now()*.001;yc.uniforms.iTime.value=e,bc.uniforms.iTime.value=e,yc.uniforms.iFrame.value=vc,performance.now()-Oc>100&&yc.uniforms.iMouse.value.set(0,0,0,0),yc.uniforms.uBrushSize.value=$.brushSize,yc.uniforms.uBrushStrength.value=$.brushStrength,yc.uniforms.uFluidDecay.value=$.fluidDecay,yc.uniforms.uTrailLength.value=$.trailLength,yc.uniforms.uStopDecay.value=$.stopDecay,bc.uniforms.uDistortionAmount.value=$.distortionAmount,bc.uniforms.uColorIntensity.value=$.colorIntensity,bc.uniforms.uSoftness.value=$.softness,bc.uniforms.uColor1.value.set(...uc($.color1)),bc.uniforms.uColor2.value.set(...uc($.color2)),bc.uniforms.uColor3.value.set(...uc($.color3)),bc.uniforms.uColor4.value.set(...uc($.color4)),yc.uniforms.iPreviousFrame.value=_c.texture,fc.setRenderTarget(gc),fc.render(Sc,dc),bc.uniforms.iFluid.value=gc.texture,fc.setRenderTarget(null),fc.render(Cc,dc);let t=gc;gc=_c,_c=t,vc++}window.addEventListener(`resize`,()=>{console.log(`resize fired, resetting frameCount`);let e=window.innerWidth,t=window.innerHeight;fc.setSize(e,t),yc.uniforms.iResolution.value.set(e,t),bc.uniforms.iResolution.value.set(e,t),mc.setSize(e,t),hc.setSize(e,t),vc=0}),kc();